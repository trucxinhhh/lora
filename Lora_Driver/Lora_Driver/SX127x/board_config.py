...
class BOARD:
    ...
    DIO0 = 26   # RaspPi GPIO 26
    DIO1 = 20   # RaspPi GPIO 20
    DIO2 = 16   # RaspPi GPIO 16
    DIO3 = 12   # RaspPi GPIO 12
    LED  = 19   # RaspPi GPIO 19 connects to the LED on the proto shield
    RST  = 21   # RaspPi GPIO 21
    NSS = 24
    #SWITCH = 25  # RaspPi GPIO 4 connects to a switch
